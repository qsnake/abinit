...
#define ABI_FUNC 'pred_langevin'
 ...
 use interfaces_45_geomoptim, except_this_one => pred_langevin
...
!Local variables-------------------------------
!scalars
 integer  :: ii,jj,kk,iatom,idim,iatom1,iatom2,itypat,idum=5,mcfac
...
!write(std_out,*) 'RPRIM original'
!do ii=1,3
!write(std_out,*) rprim(:,ii)
!end do

!write(std_out,*) 'RPRIMD computed'
!do ii=1,3
!write(std_out,*) rprimd(:,ii)
!end do
