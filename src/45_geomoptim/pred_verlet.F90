...
!!
!! CHILDREN
!!      hist2var,metric,mkrdim,var2hist,wrtout,xfpack_f2vout,xfpack_vin2x
!!      xfpack_x2vin,xredxcart
!!
!! SOURCE
...
!scalars
 ...
 real(dp) :: taylor,amass_tot
 real(dp),save :: ucvol,ucvol0,ucvol_next
 real(dp) :: etotal
 real(dp) :: diag,favg
...
!arrays
 ...
 real(dp),allocatable,save :: vel_prevhalf(:,:)
 real(dp),save :: acell(3),acell0(3)
 real(dp),save :: acell_next(3)
 real(dp),save :: rprimd(3,3),rprimd0(3,3),rprim(3,3)
 real(dp),save :: rprimd_next(3,3),rprim_next(3,3)
 real(dp) :: gprimd(3,3)
 real(dp) :: gmet(3,3)
 real(dp) :: rmet(3,3)
...
&   rprimd0,ab_mover%symrel,ucvol_next,ucvol0,&
&   vin_next,xred_next)
   taylor=half
 end if
...
& ab_mover%nsym,ab_mover%optcell,rprim_next,rprimd0,&
