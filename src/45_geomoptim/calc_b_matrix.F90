...
!DEBUG
!write(std_out,*) 'calc_b_matrix : enter'
!ENDDEBUG
...
#define ABI_FUNC 'dbond_length_d1'
 use interfaces_45_geomoptim, except_this_one => dbond_length_d1
!End of the abilint section
...
#define ABI_FUNC 'dang_d1'
 ...
 use interfaces_45_geomoptim, except_this_one => dang_d1
!End of the abilint section
...
#define ABI_FUNC 'dang_d2'
 use interfaces_32_util
 use interfaces_45_geomoptim, except_this_one => dang_d2
!End of the abilint section
