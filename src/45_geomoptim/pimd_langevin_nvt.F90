...
!!
!! CHILDREN
!!      pimd_energies,pimd_forces,pimd_initvel,pimd_langevin_forces
!!      pimd_langevin_random,pimd_langevin_random_init,pimd_mass_spring
...
!arrays
 real(dp),intent(in) :: rprimd(3,3),etotal(trotter)
...
!scalars
 integer :: idum=-5
 integer :: iimage,irestart,ndof,prtstress
 real(dp) :: dtion,eharm,eharm2,epot,friction,initemp,kt,rescale_temp
