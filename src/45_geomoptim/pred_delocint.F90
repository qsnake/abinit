...
!!      xfh_recover_deloc,xfpack_f2vout,xfpack_vin2x,xfpack_x2vin,xredxcart
!!
!! SOURCE
...
!  TODO:
!  all of the following should go into an init routine in m_delocint
