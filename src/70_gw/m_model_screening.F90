!{\src2tex{textfont=tt}}
!!****f* ABINIT/m_model_screening
!! NAME
!! m_model_screening
!!
!! FUNCTION
!!  Module containing functions for calculating and fitting model
!!  dielectric functions
!!
!! COPYRIGHT
!!  Copyright (C) 2008-2012 ABINIT group (MS)
...
!!
!! PARENTS
!!      calc_sigc_pole_cd,m_screening,mrgscr
!!
!! CHILDREN
!!
!! SOURCE
...
! *********************************************************************
  ...
  unt_tmp = get_unit()
  open(unt_tmp,file="grid_peak_tree.dat")
  do iim=nfreqim,1,-1
