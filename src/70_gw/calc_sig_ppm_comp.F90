...
!!
!! COPYRIGHT
!! Copyright (C) 1999-2012 ABINIT group (FB, GMR, VO, LR, RWG, RShaltaf)
...
!*************************************************************************
 ...
 if (ppmodel/=1.and.ppmodel/=2) then
   write(msg,'(a,i3,a)')' The completeness trick cannot be used when ppmodel is ',ppmodel,' It should be set to 1 or 2. '
   MSG_ERROR(msg)
 end if
