...
&   ' Proper piezoelectric constants (clamped ion) (unit:c/m^2)',ch10
   ...
   do ivarA=1,6
     write(std_out,'(3f16.8)')piezo_clamped(ivarA,1),piezo_clamped(ivarA,2),&
