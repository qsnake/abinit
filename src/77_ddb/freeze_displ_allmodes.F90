...
!!
!! CHILDREN
!!      destroy_supercell,freeze_displ_supercell,init_supercell
!!      nullify_supercell,prt_supercell
!!
!! SOURCE
!!
...
!  print out everything for this wavevector and mode
   call prt_supercell (phfreq(jmode), jmode, outfile_radix, scell, typat)
 end do
