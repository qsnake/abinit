...
!!
!! COPYRIGHT
!! Copyright (C) 2004-2012 ABINIT group (MVerstra)
...
!Local variables-------------------------------
!scalars
 integer :: ikpt_phon,iqpt,isppol,qtor
!arrays
...
!for each qpt do FT to recuperate original values
 ...
 isppol = 1
 qtor = 0
 ABI_ALLOCATE(gkq_disk,(2,elph_ds%ngkkband*elph_ds%ngkkband,elph_ds%nbranch*elph_ds%nbranch,elph_ds%k_phon%nkpt,elph_ds%nsppol))
 ABI_ALLOCATE(tmp_gkq,(2,elph_ds%ngkkband*elph_ds%ngkkband,elph_ds%nbranch*elph_ds%nbranch,elph_ds%k_phon%nkpt,elph_ds%nsppol))
