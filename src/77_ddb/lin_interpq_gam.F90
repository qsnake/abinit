...
!the array gamma_qpt has dimensions: (2,nbranch**2,nsppol,elph_ds%k_fine%nkpt)
 ...
 do ibranch=1,nbranch**2
   call interpol3d(qpt_incube,kptrlatt(1,1),kptrlatt(2,2),kptrlatt(3,3),gam_intp,gamma_qpt(1,ibranch,isppol,:))
   gam_now(1,ibranch) = gam_intp

   call interpol3d(qpt_incube,kptrlatt(1,1),kptrlatt(2,2),kptrlatt(3,3),gam_intp,gamma_qpt(2,ibranch,isppol,:))
