...
!!
!! CHILDREN
!!      gam_mult_displ,leave_new,wrtout,zgemm
!!
!! SOURCE
...
&   ' elph_ds%ep_keepbands should be 1 while is ',elph_ds%ep_keepbands
   ...
   do ikpt_phon=1,elph_ds%k_phon%nkpt
     ...
     do ib1=1,elph_ds%nFSband
       ...
       do ib2=1,elph_ds%nFSband
         ...
         zgemm_tmp_mat= reshape (h1_mat_el_sq(:,ibeff,:,ikpt_phon,isppol),(/2,elph_ds%nbranch,elph_ds%nbranch/))
...
!          factor of pi here
           gkq_1band(1,ipert1,ipert1) = gkq_1band(1,ipert1,ipert1) + pi*tmp_mat2(1,ipert1,ipert1)
         end do
...
!        gamma matrix contribution in cartesian coordinates (ie interpolatable form)
         h1_mat_el_sq(:,ibeff,:,ikpt_phon,isppol) = reshape(gkq_1band,(/2,elph_ds%nbranch*elph_ds%nbranch/))
