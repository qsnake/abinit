...
!    DEBUG
!    write(std_out,*)' chkneu : dtset%nband(1),dtset%nsppol,nocc'
!    write(std_out,*)dtset%nband(1),dtset%nsppol,nocc
!    stop
!    ENDDEBUG
...
!    DEBUG
!    write(std_out,*)'nocc,occlast,maxocc,dtset%nband(1)',nocc,occlast,maxocc,dtset%nband(1)
!    write(std_out,*)'tmpocc=',tmpocc(:)
!    ENDDEBUG
