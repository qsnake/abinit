! This file has been automatically generated, do not modify.
  ...
  subroutine ab6_invars_get_integer(dtsetsId, value, id, idtset, errno)
    ...
    case (ab6_invars_use_gpu_cuda)
      value = token%dtsets(idtset)%use_gpu_cuda
    case (ab6_invars_prepscphon)
      value = token%dtsets(idtset)%prepscphon
    ...
    case (ab6_invars_chkgwcomp)
      value = token%dtsets(idtset)%chkgwcomp
    ...
    case (ab6_invars_gw_reconst_scr)
      value = token%dtsets(idtset)%gw_reconst_scr
    ...
    case (ab6_invars_irdpawden)
      value = token%dtsets(idtset)%irdpawden
    case (ab6_invars_prtgden)
      value = token%dtsets(idtset)%prtgden
    case (ab6_invars_gw_custom_freqsp)
      value = token%dtsets(idtset)%gw_custom_freqsp
    ...
    case (ab6_invars_cd_custom_imfrqs)
      value = token%dtsets(idtset)%cd_custom_imfrqs
    case (ab6_invars_bs_loband)
      value = token%dtsets(idtset)%bs_loband
    ...
    case (ab6_invars_gw_use_pole_scr)
      value = token%dtsets(idtset)%gw_use_pole_scr
    ...
    case (ab6_invars_gw_eet_inclvkb)
      value = token%dtsets(idtset)%gw_eet_inclvkb
  ...
  subroutine ab6_invars_get_real(dtsetsId, value, id, idtset, errno)
    ...
    case (ab6_invars_cd_halfway_freq)
  ...
  subroutine ab6_invars_get_integer_array(dtsetsId, values, n, id, idtset, errno)
    ...
    case (ab6_invars_cd_subset_freq)
