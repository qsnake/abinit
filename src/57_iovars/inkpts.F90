...
!arrays
 ...
 real(dp),intent(out) :: kpt(3,nkpt),shiftk(3,8),wtk(nkpt)
...
!DEBUG
 write(std_out,*)' inkpts : enter'
!Warning : do not try to print istwfk when the input nkpt=0
!write(std_out,*)' inkpts : istwfk=',istwfk
!stop
!ENDDEBUG
...
!  DEBUG
!  write(std_out,*)' inkpts : after init, kptrlatt='
!  write(std_out,'(9i3)' )kptrlatt(:,:)
!  ENDDEBUG
...
!  DEBUG
!  write(std_out,*)' inkpts : before testkgrid, kptrlatt='
!  write(std_out,'(9i3)' )kptrlatt(:,:)
!  ENDDEBUG
...
!  DEBUG
!  write(std_out,*)' inkpts : after getkgrid, nkpt=',nkpt
!  ENDDEBUG
...
!DEBUG
!write(std_out,*)' inkpts : istwfk before intagm ',istwfk(1:nkpt)
!ENDDEBUG
...
!DEBUG
 write(std_out,*)' inkpts : exit '
!write(std_out,*)'    nkpt=',nkpt
!write(std_out,*)'  istwfk=',istwfk
!stop
!ENDDEBUG
