...
!  Test the ability to allocate the biggest array
   ...
   ABI_ALLOCATE(bigarray,(32*1024,nquarter_mbytes))
   ier = ABI_ALLOC_STAT
   if(ier/=0)then
...
&     ' Mbytes, for testing purposes. '
   ...
   if(allocated(bigarray))ABI_DEALLOCATE(bigarray)
...
!  total memory
   ...
   ABI_ALLOCATE(bigarray1,(32*1024,nquarter_mbytes))
   ier1 = ABI_ALLOC_STAT
   ABI_ALLOCATE(bigarray2,(32*1024,nquarter_mbytes))
   ier2 = ABI_ALLOC_STAT
   ABI_ALLOCATE(bigarray3,(32*1024,nquarter_mbytes))
   ier3 = ABI_ALLOC_STAT
   ABI_ALLOCATE(bigarray4,(32*1024,nquarter_mbytes))
   ier4 = ABI_ALLOC_STAT
   ABI_ALLOCATE(bigarray5,(32*1024,nquarter_mbytes))
   ier5 = ABI_ALLOC_STAT
   ABI_ALLOCATE(bigarray6,(32*1024,nquarter_mbytes))
   ier6 = ABI_ALLOC_STAT
   ABI_ALLOCATE(bigarray7,(32*1024,nquarter_mbytes))
   ier7 = ABI_ALLOC_STAT
   ABI_ALLOCATE(bigarray8,(32*1024,nquarter_mbytes))
   ier8 = ABI_ALLOC_STAT
...
&     ' The job will continue.'
   ...
   if(allocated(bigarray1))ABI_DEALLOCATE(bigarray1)
   if(allocated(bigarray2))ABI_DEALLOCATE(bigarray2)
   if(allocated(bigarray3))ABI_DEALLOCATE(bigarray3)
   if(allocated(bigarray4))ABI_DEALLOCATE(bigarray4)
   if(allocated(bigarray5))ABI_DEALLOCATE(bigarray5)
   if(allocated(bigarray6))ABI_DEALLOCATE(bigarray6)
   if(allocated(bigarray7))ABI_DEALLOCATE(bigarray7)
   if(allocated(bigarray8))ABI_DEALLOCATE(bigarray8)
