...
!!
!! CHILDREN
!!      alloc_dens_cuda,dealloc_dens_cuda,density_cuda,density_rec,leave_new
!!      timab,wrtout,xbarrier_mpi,xsum_mpi
!!
!! NOTES
!!  at this time :
!!
...
!deallocate array on GPU
 if(gputopo) call dealloc_dens_cuda()
 call timab(613+swt_tm,1,tsec2)  !!--start time-counter: sync gpu-cpu
 call xbarrier_mpi(mpi_enreg%commcart)
