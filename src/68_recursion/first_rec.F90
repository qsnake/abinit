...
!!      random_number,recursion,reshape_pot,timab,timein,wrtout,xsum_mpi
!!
!! SOURCE
...
! *************************************************************************
 ...
 write(msg,'(a)')'WARNING : RECURSION'; call wrtout(std_out,msg,'COLL')
...
!  --Get Total Times
   call xsum_mpi(time_f,rset%mpi%commcart,ierr)
   call xsum_mpi(time_cu,rset%mpi%commcart,ierr)
