...
!--For any pseudo potential:
 do ipseudo = 1, psps%npsp !--Loop on the pseudos
   write(msg,'(a,80a)')' pseudo file',('-',ii=1,10); call wrtout(std_out,msg,'COLL')
   write(msg,'(a)') psps%filpsp(ipseudo);call wrtout(std_out,msg,'COLL')
...
!    strength is calculated differently
     select case(iangol)
       case(0) 
!        write(msg,'(a)')'projectors s'; call wrtout(std_out,msg,'COLL')
       ...
       case(1) 
!        write(msg,'(a)')'projectors p'; call wrtout(std_out,msg,'COLL')
       ...
       case(2)
!        write(msg,'(a)')'projectors d'; call wrtout(std_out,msg,'COLL')
       ...
       case(3)
!        write(msg,'(a)')'projectors f'; call wrtout(std_out,msg,'COLL')
         h_mat_init(1,2) = zero;  h_mat_init(1,3) = zero;  h_mat_init(2,3) = zero; 
         case default 
         write(msg,'(a)')' error angular: moment component'; call wrtout(std_out,msg,'COLL')
     end select
...
!      (eival=transpose(eivec).h_mat_init.eivec)
       write(msg,'(a,3d10.3)')'  eigenvalues=',eig_val_h; call wrtout(std_out,msg,'COLL')
