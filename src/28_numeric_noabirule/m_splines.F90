...
!!
!! COPYRIGHT
!!  Copyright (C) 2010-2012 ABINIT group (YP, BAmadon)
...
!!
!! PARENTS
!!      atomden,calc_sigc_cd,calc_sigc_pole_cd,cc_derivatives,denfgr,hirsh
!!      init_bess_spl,init_occ_ent,integrho,m_atom,m_paw_pwij,m_paw_slater
!!      m_paw_toolbox,m_splines,optics_paw_core,pawdij0,pawinit,pawkij
!!      predict_string,psp10in,psp10nl,psp11nl,psp1cc,psp1in,psp1nl,psp2in
!!      psp2nl,psp3in,psp3nl,psp4cc,psp5in,psp5nl,psp6cc,psp6in,psp7cc,psp7in
!!      psp7nl,psp8in,psp8lo,psp8nl,psp9in,spline_paw_fncs,upf2abinit
!!      vso_realspace_local
!!
!! CHILDREN
!!      splint
...
!!
!! PARENTS
!!      atomden,calc_sigc_cd,calc_sigc_pole_cd,cc_derivatives,denfgr,m_atom
!!      m_paw_slater,m_paw_toolbox,m_splines,optics_paw_core
!!      partial_dos_fractions,pawdij0,pawgylm,pawkij,predict_string,psp6cc
!!      psp7cc,psp7in,psp9in,spline_paw_fncs,vso_realspace_local,wffile
!!
!! CHILDREN
!!      splint
!!
