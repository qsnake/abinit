...
!!
!! PARENTS
!!      atomden,cpdrv,critics,denfgr,exc_diago,get_fsurf_1band,get_full_gsphere
!!      get_g_tiny,invacuum,m_bz_mesh,m_gsphere,m_paw_toolbox,m_screen
!!      m_screening,m_tetrahedron,m_use_ga,m_vcoul,m_wannier2abinit,mlwfovlp_qp
!!      mrgscr,partial_dos_fractions,pawgylm,rsiaf9,setshells,shellstruct
!!      sigma_interp,spectral,symkpt,tddft,thmeig,wffile
!!
!! CHILDREN
!!
!! SOURCE
