...
!The parameter tol5 defines the treshhold for degeneracy,
!and the width of the step function

 rocceig(:,:)=0.0_dp

!DEBUG
!write(std_out,*)' ibandk,ibandkq,diffeig,diffocc '
!ENDDEBUG
...
!    DEBUG
!    write(std_out,'(2i4,2es22.12)' )ibandk,ibandkq,diffeig,diffocc
!    ENDDEBUG
...
!        case there is no contribution from this pair of bands
         if( abs(diffocc) > tol5 ) then
           write(message,'(a,a,a,a,a,a,a,a,a,2(a,i4,a,es16.6,a,es16.6,a,a),a)' ) &
&           ' occeig : ERROR -',ch10,&
...
!DEBUG
!write(std_out,*)' occeig : '
!write(std_out,*)'  ibandk , rocceig(:,ibandk)'
!do ibandk=1,nband_k
!write(std_out,'(i3,5es14.4)' )ibandk,rocceig(1:min(5,nband_k),ibandk)
!if(nband_k>5)write(std_out,'(a,5es14.4)' )'   ',rocceig(6:min(10,nband_k),ibandk)
!end do
!stop
!ENDDEBUG
