...
MODULE m_fstrings
 ...
 public :: OPERATOR(.jn.)  
 public :: str_conct       ! Concatenate two strings (function version for buggy PGI)
...
#else
  !FIXME this is for Win$, but I need CPP variables and autotools support 
  character(len=1),parameter :: DIR_SEPARATOR = '\'
#endif
