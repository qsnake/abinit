...
MODULE m_errors
 ...
 public :: netcdf_ioerr     ! Stop execution after a NetCDF I/O error
 ...
 integer,save,public ::  ERR_ALLOCATE_STAT ! Store the status reported by Fortran allocate
...
subroutine netcdf_ioerr(ncerr,file_name,file_line)
...
! *********************************************************************
 ...
 !call xbarrier_mpi(xmpi_world) ! Do not use it unless you know what you are doing!
