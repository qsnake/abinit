...
!!
!! COPYRIGHT
!! Copyright (C) 2009-2012 ABINIT group (DCA, XG, GMR, FrD, AF, MT)
...
#define ABI_FUNC 'pspheads_comm'
 ...
 use interfaces_51_manage_mpi, except_this_one => pspheads_comm
...
!  broadcast rpaw values
   ABI_ALLOCATE(list_dpr,(1*npsp))
   list_dpr(1:npsp)=pspheads(1:npsp)%pawheader%rpaw
   call MPI_BCAST(list_dpr,1*npsp,MPI_DOUBLE_PRECISION,0,&
&   xmpi_world,ierr)
