...
#undef ABI_FUNC
#define ABI_FUNC 'back_wf'
 use interfaces_18_timing
 use interfaces_51_manage_mpi
 use interfaces_52_fft_mpi_noabirule, except_this_one => back_wf
...
!!      end interface
        ...
        if(.false.)write(std_out,*)iproc,nproc
...
!DEBUG
!       write(std_out,'(a,3i4)' )'back_wf,zf n1,n2,n3',n1,n2,n3
...
!          ii2=(i2-1)*mpi_enreg%nproc_fft+mpi_enreg%me_fft+1
!          if(ii2 > max2+1) then;j2=i2-md2proc+n2/mpi_enreg%nproc_fft; else; j2=i2;end if
!          write(std_out,'(6i4,2es16.6)')i1,i2,i3,ii1,j2,i3,zmpi2(1:2,i1,i2,i3)
!         end do
!        end do
!       end do
!call leave_new("COLL")
...
!DEBUG
!       write(std_out,*)' in back_wf,j3, zt =',j3
!       do i1=1,n1
!        do i2=1,m2
!         if(i2 > max2+1) then ;ii2=i2+n2-m2;else; ii2=i2;end if !ii2 is the value in the full
!         write(std_out,'(3i4,2es16.6)')i2,ii2,i1,zt(1:2,i2,i1)
!        end do
!       end do
!       stop
!ENDDEBUG
...
!DEBUG
!       write(std_out,*)' j3=1, after switchreal_cent, includelast=',includelast
!       do i1=1,n1dfft*n2
!        write(std_out,'(2i4,2es16.6)')i1,i1,zw(1:2,i1,1)
!       end do
!       stop
!ENDDEBUG
...
!DEBUG
!       write(std_out,*)' j3=1, before rearrangement, zr ='
!       do i1=1,n1
!        do i2=1,n2
!         write(std_out,'(2i4,2es16.6)')i1,i2,zr(1:2,i1,i2,j3,idat)
!        end do
!       end do
!       stop
!ENDDEBUG
