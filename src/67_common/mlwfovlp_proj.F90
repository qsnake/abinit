...
!!
!! COPYRIGHT
!! Copyright (C) 2005-2012 ABINIT group (BAmadon,FJollet,TRangel,drh)
...
!!
!! CHILDREN
!!      leave_new,mlwfovlp_radial,mlwfovlp_ylmfac,wrtout,xcomm_init
!!      xmaster_init,xme_init,xproc_init,ylm_cmplx
!!
!! SOURCE
...
!scalars
 ...
 integer :: sumtmp
 integer :: master,max_lmax,max_lmax2,mproj,nprocs,spaceComm,rank
...
!      
       do iband1=1,mband
         ...
         do iband2=1,nwan(isppol)
           ...
           amn(2,iband1,iband2,ikpt,isppol)=amn(1,iband1,iband2,ikpt,isppol)/xnormb
         end do !iband2
       end do !iband1
     end do !ikpt
   end do !isppol
