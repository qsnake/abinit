...
!!
!! CHILDREN
!!      dzgedi,dzgefa,hdr_skip,leave_new,matr3inv,rwwf,wrtout,xredxcart
!!
!! SOURCE
...
!scalars
 ...
 integer,intent(in) :: nspinor,nsppol,ntypat,unkg
...
!scalars
 ...
 integer :: iattyp,iband,iberry,icg,ierr,ii,ikpt,ikpt2,index,index1,info
 integer :: ipw,isp,isppol,istr,itypat,iunmark,jband,jj,jkpt,jkstr
 integer :: jkstr_ori,jpw,lkstr,lkstr_ori,lkstr_ori_,maxband,mcg_disk
...
!ENDDEBUG
 ...
 if(nspinor==2)then
   write(std_out,*)' berryphase : does not yet work for nspinor=2'
   call leave_new('COLL')
 end if
...
!    call xdefineOff(formeig,wffnow,mpi_enreg,nband,npwarr,nspinor,nsppol,nkpt)
     ...
     ABI_ALLOCATE(cg_disk,(2,mcg_disk,2))
     rewind unkg
