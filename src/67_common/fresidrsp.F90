...
!arrays
 ...
 real(dp),allocatable :: dummy_in(:),dummy_out(:),gauss(:,:),vresg(:,:),work(:)
...
& ee,gauss,gmet,gprimd,gresid,dummy_out,gsqcut,&
...
& ucvol,usepaw,vresg,dummy2,dummy_in)
