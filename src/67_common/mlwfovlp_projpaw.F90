...
!!
!! COPYRIGHT
!!  Copyright (C) 2009-2012 ABINIT group (T. Rangel)
...
!!
!! CHILDREN
!!      leave_new,mlwfovlp_ylmfar,simp_gen,simpson_int,wrtout,xredxcart
!!
!! SOURCE
...
!  
   ...
   call xredxcart(natom,1,rprimd,xcart_unit,xred_unit)
   call xredxcart(mwan,1,rprimd,proj_cart(:,:,isppol),proj_site_unit(:,:,isppol))
!  
