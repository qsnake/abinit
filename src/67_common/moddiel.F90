...
!  Here, model dielectric function (G-diagonal operator)
   ...
   if (optreal==1) ABI_ALLOCATE(work2,(cplex*nfft))
...
!    End of loop on spin polarizations
   ...
   if (optreal==1) ABI_DEALLOCATE(work2)

!  End condition diemac/=1.0
 end if

!DEBUG
!write(std_out,*)' moddiel : exit '
!stop
!ENDDEBUG
