...
!!
!! COPYRIGHT
!! Copyright (C) 1998-2012 ABINIT group (DCA, XG, GMR, MF, AR, MM)
...
#define ABI_FUNC 'vtorhotf'
 ...
 use interfaces_67_common, except_this_one => vtorhotf
...
!scalars
 ...
 integer :: me_fft,n1,n2,n3,nfftot,nproc_fft,prtvol,spaceComm
...
&     nfft)
     ...
     if (jdicho > jdichomax) then
       write(std_out,*) 'NEWTON RAPHSON NOT CONVERGED'
       stop
     end if
   end do
   fermie=rtnewt
