...
!DEBUG
!write(std_out,*)' strhar : enter '
!n1=ngfft(1) ; n2=ngfft(2) ; n3=ngfft(3)
!write(std_out,*)' strhar : n1,n2,n3',n1,n2,n3
!ENDDEBUG
...
!Conduct looping over all fft grid points to find G vecs
!inside gsqcut
...
!DO not remove : seems needed to avoid problem with pathscale compiler, in
!parallel
...
!Init mpi_comm
 if(mpi_enreg%paral_compil_fft==1)then
   ...
   call xsum_mpi(harstr,spaceComm ,ierr)
