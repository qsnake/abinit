...
!!
!! COPYRIGHT
!! Copyright (C) 2007-2012 ABINIT group (SC)
...
!DEBUG
!write(std_out,*)' jellium : enter, option= ',option
!write(std_out,'(a,3f20.14)')' slabwsrad, slabzstart, slabzend= ',&
...
!  Update the initial electronic density adding -rhjr
 ...
 ABI_DEALLOCATE(rhjg)
 ABI_DEALLOCATE(rhjr)
 if(option==1) ABI_DEALLOCATE(vjelg)
