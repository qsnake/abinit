...
!!
!! COPYRIGHT
!! Copyright (C) 2000-2012 ABINIT  group (MVeithen,ISouza,JIniguez)
...
!scalars
 ...
 real(dp) :: aa,angle,bb,big_axis,cc,cphi_0,delta_theta,e0,e1,e1h
...
!DEBUG
!write(std_out,*)' linemin: debug, enter.'
!ENDDEBUG
...
!  write(std_out,'(4(f16.9))')(theta-delta_theta),e0h,e1h,e1fdiff
!  end if
!  e0h = e0
!  ENDDEBUG
