...
!scalars
 ...
 integer :: iblk1,iblk2,ipw,ipw1,ipw2,ispinor,istwf_k,iwf,jsp,mblk
...
&           lmax_diel,mgfftdiel,mpi_enreg,natom,nband_k,ndiel4,ndiel5,ndiel6,&
...
!        In case of PAW, add compensation charge contribution if not already done
         if (usepaw==1.and.extrap==0.and.neglect_pawhat==0) then
           call pawsushat(atindx1,cprj_k,gbound_diel,gylmg_diel,iband,iband,1,1,istwf_k,kg_diel,&
&           lmax_diel,mgfftdiel,mpi_enreg,natom,nband_k,ndiel4,ndiel5,ndiel6,&
...
!              In case of PAW, add compensation charge contribution
               if (usepaw==1.and.neglect_pawhat==0) then
                 call pawsushat(atindx1,cprj_k,gbound_diel,gylmg_diel,ibd1,ibdshft2,ispinor,ispinor,istwf_k,kg_diel,&
&                 lmax_diel,mgfftdiel,mpi_enreg,natom,nband_k,ndiel4,ndiel5,ndiel6,&
&                 ngfftdiel,npwdiel,nspinor,ntypat,0,paral_kgb,&
&                 pawang,pawtab,ph3d_diel,typat,wfprod,dummy)
               end if
