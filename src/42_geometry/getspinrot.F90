...
!Compute determinant of the matrix
 det=symrel1(1,1)*symrel1(2,2)*symrel1(3,3)+&
& symrel1(2,1)*symrel1(3,2)*symrel1(1,3)+&
& symrel1(1,2)*symrel1(2,3)*symrel1(3,1) - &
& (symrel1(3,1)*symrel1(2,2)*symrel1(1,3)+&
& symrel1(2,1)*symrel1(1,2)*symrel1(3,3)+&
& symrel1(3,2)*symrel1(2,3)*symrel1(1,1))
