/* Fortran interface for m_ab6_symmetry.F90. */


#ifndef M_AB6_SYMMETRY_EXPORT_H
#define M_AB6_SYMMETRY_EXPORT_H

#define SYM_NAME(a,A)     ABI_FC_MOD(m_ab6_symmetry,M_AB6_SYMMETRY,	\
