...
!!
!! PARENTS
!!      ingeo,initberry,irred_perts,m_ab6_symmetry,m_crystal,rdddb9,setsym
!!      thmeig
!!
!! CHILDREN
!!      symchk,wrtout
...
&         '  tolerance.  Should check atomic coordinates and symmetry group input data.'
 ...
 do iatom=1,natom
   write(message, '(a,i6,a)' )' symatm: atom number',iatom,' is reached starting at atom'
   call wrtout(std_out,message,'COLL')
   do ii=1,(nsym-1)/24+1
     if(natom<100)then
...
!!DEBUG
!write(std_out,*) '42_geometry/symatm OUTPUT VARIABLES'
!write(std_out,*) 'indsym',indsym
!write(std_out,*) ' '
!write(ab_out,*) '42_geometry/symatm OUTPUT VARIABLES'
