...
!DEBUG
!write(std_out,*)' symmultsg : enter, builds the space group symmetry '
!ENDDEBUG
...
!      Check for the ferromagnetic character
 ...
 write(std_out,*) ' Space group multiplication table'
 do isym=1,nsym
   write(std_out,*) ' Combined operations for the symmetry operation number: ',isym
   do ii=1,14
     if (nsym>ii*16) then
