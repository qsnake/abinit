...
!!
!! COPYRIGHT
!! Copyright (C) 2000-2012 ABINIT group (XG)
...
!!
!! PARENTS
!!      ingeo,inqpt,m_ab6_symmetry,symanal,symbrav,thmeig
!!
!! CHILDREN
...
!DEBUG
!write(std_out,*)' symlatt : enter'
!write(std_out,*)' symlatt : tolsym=',tolsym
!write(std_out,*)' symlatt : rprimd(:,1)=',rprimd(:,1)
!write(std_out,*)' symlatt : rprimd(:,2)=',rprimd(:,2)
!write(std_out,*)' symlatt : rprimd(:,3)=',rprimd(:,3)
!ENDDEBUG
...
!    Checks that the basis vectors are OK for the target holohedry
     call holocell(cell_base,foundc,iholohedry,tolsym)
   end if

!  DEBUG
!  write(std_out,*)' after test_orth, foundc=',foundc
!  ENDDEBUG
...
!    DEBUG
!    write(std_out,*)' symlatt : iholohedry,itrial=',iholohedry,itrial
!    ENDDEBUG
...
!    DEBUG
!    write(std_out,*)' after test_6, foundc=',foundc
!    ENDDEBUG
...
!    DEBUG
!    write(std_out,*)' after test_a, foundc=',foundc
!    ENDDEBUG
...
!    DEBUG
!    write(std_out,*)' after test_d, foundc=',foundc
!    ENDDEBUG
...
!    DEBUG
!    write(std_out,*)' after test_e, foundc=',foundc
!    ENDDEBUG
...
!    DEBUG
!    write(std_out,*)' after test_f, foundc=',foundc
!    ENDDEBUG
...
!        ENDDEBUG
         if(abs(two*scalarprod+norm2a)<tolsym)then
           fact=1 ; center=0
...
!    DEBUG
!    write(std_out,*)' after test_3b, foundc=',foundc
!    ENDDEBUG
...
!    DEBUG
!    write(std_out,*)' after test_3c, foundc=',foundc
!    ENDDEBUG
...
!    DEBUG
!    write(std_out,*)' after test_3d, foundc=',foundc
!    ENDDEBUG
...
!    DEBUG
!    write(std_out,*)' after direction, foundc=',foundc
!    ENDDEBUG
...
!write(std_out,'(a,3es14.6,a,3es14.6,a,3es14.6)')' basis =',&
!&  cell_base(:,1),ch10,cell_base(:,2),ch10,cell_base(:,3)
!write(std_out,'(a,3es14.6,a,3es14.6,a,3es14.6)')' metmin =',&
...
&       ' symlatt : the Bravais lattice is oC (one-face-centered orthorhombic)'
       ...
       write(message,'(a,a)')ch10,&
&       ' symlatt : the Bravais lattice is oF (face-centered orthorhombic)'
     end if
   end if
