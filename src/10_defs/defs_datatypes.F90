...
!----------------------------------------------------------------------
!!****t* defs_datatypes/coeffi1_type
!! NAME
!! coeffi1_type
!!
!! FUNCTION
!! A small datatype for ragged 2D-arrays.
!!
!! SOURCE
...
!!****t* defs_datatypes/coeff2_gwpc_type
!! NAME
!! coeff2_gwpc_type
!!
!! FUNCTION
...
!!****t* defs_datatypes/coeff3_gwpc_type
!! NAME
!! coeff3_gwpc_type
!!
!! FUNCTION
...
!! SOURCE
 ...
 type coeff3_gwpc_type

  !$integer :: size(3)
  complex(gwpc),pointer :: value(:,:,:) ! SET2NULL

 end type coeff3_gwpc_type
!!***
