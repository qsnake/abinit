...
!Do not modify the following lines by hand.
#undef ABI_FUNC
#define ABI_FUNC 'xsum_mpi_intv2'
!End of the abilint section
...
!Do not modify the following lines by hand.
#undef ABI_FUNC
#define ABI_FUNC 'xsum_mpi_int2t'
!End of the abilint section
...
!Do not modify the following lines by hand.
#undef ABI_FUNC
#define ABI_FUNC 'xsum_mpi_int2d'
!End of the abilint section
...
!Do not modify the following lines by hand.
#undef ABI_FUNC
#define ABI_FUNC 'xsum_mpi_int3d'
!End of the abilint section
...
!Do not modify the following lines by hand.
#undef ABI_FUNC
#define ABI_FUNC 'xsum_mpi_int4d'
!End of the abilint section
...
!Local variables-------------------
#if defined HAVE_MPI
 integer :: n1,n2,n3,n4,n5,n6,n7, istat
 real(dp) , allocatable :: xsum(:,:,:,:,:,:,:)
 integer :: nproc_space_comm
#endif
...
!    Accumulate xval on all proc. in spaceComm
     ...
     istat = ABI_ALLOC_STAT
     if (istat /= 0) stop 'error allocating xsum in xsum_mpi_dp7d'
     call MPI_ALLREDUCE(xval,xsum,n1*n2*n3*n4*n5*n6*n7,MPI_DOUBLE_PRECISION,&
&     MPI_SUM,spaceComm,ier)
     xval (:,:,:,:,:,:,:) = xsum(:,:,:,:,:,:,:)
     ABI_DEALLOCATE(xsum)
   end if
...
!Do not modify the following lines by hand.
#undef ABI_FUNC
#define ABI_FUNC 'xsum_mpi_dp3d2t'
!End of the abilint section
...
!Do not modify the following lines by hand.
#undef ABI_FUNC
#define ABI_FUNC 'xsum_mpi_dp4d2t'
!End of the abilint section
...
!Do not modify the following lines by hand.
#undef ABI_FUNC
#define ABI_FUNC 'xsum_mpi_c1cplx'
!End of the abilint section
...
!Do not modify the following lines by hand.
#undef ABI_FUNC
#define ABI_FUNC 'xsum_mpi_c2cplx'
!End of the abilint section
...
!Do not modify the following lines by hand.
#undef ABI_FUNC
#define ABI_FUNC 'xsum_mpi_c3cplx'
!End of the abilint section
...
!Do not modify the following lines by hand.
#undef ABI_FUNC
#define ABI_FUNC 'xsum_mpi_c4cplx'
!End of the abilint section
...
!Do not modify the following lines by hand.
#undef ABI_FUNC
#define ABI_FUNC 'xsum_mpi_c5cplx'
!End of the abilint section
...
!Do not modify the following lines by hand.
#undef ABI_FUNC
#define ABI_FUNC 'xsum_mpi_c6cplx'
!End of the abilint section
...
!Do not modify the following lines by hand.
#undef ABI_FUNC
#define ABI_FUNC 'xsum_mpi_log1d'
!End of the abilint section
...
!Do not modify the following lines by hand.
#undef ABI_FUNC
#define ABI_FUNC 'xsum_mpi_log2d'
!End of the abilint section
...
!Do not modify the following lines by hand.
#undef ABI_FUNC
#define ABI_FUNC 'xsum_mpi_log3d'
!End of the abilint section
...
!  Accumulate xval on all proc. in spaceComm
   ...
   ABI_ALLOCATE(xsum,(n1,n2,n3))
   istat = ABI_ALLOC_STAT
   if (istat /= 0) stop 'error allocating xsum in xsum_mpi_log3d'
   call MPI_ALLREDUCE(xval,xsum,n1*n2*n3,MPI_LOGICAL,&
&   MPI_LOR,spaceComm,ier)
   xval (:,:,:) = xsum(:,:,:)
   ABI_DEALLOCATE(xsum)
 end if
