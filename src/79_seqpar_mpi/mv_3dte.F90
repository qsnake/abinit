...
!!
!! CHILDREN
!!      dzgedi,dzgefa,mpi_recv,mpi_send,status,wrtout,xcomm_world,xsum_mpi
!!
!! SOURCE
...
!DEBUG
!write(std_out,*)'after loop over k-points'
!write(std_out,*)'me = ',mpi_enreg%me,'d3_aux = '
!write(std_out,*)d3_aux(:,1)
!write(std_out,*)d3_aux(:,2)
!write(std_out,*)d3_aux(:,3)
!call leave_test()
!ENDDEBUG

 if (mpi_enreg%paral_compil_kpt == 1) then
   call xsum_mpi(d3_aux,spaceComm,ierr)
 end if

!DEBUG
!write(std_out,*)'after xsum_mpi'
!call leave_test()
!stop
!ENDDEBUG
