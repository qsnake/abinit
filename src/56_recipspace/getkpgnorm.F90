...
!!
!! PARENTS
!!      overlap_wf,partial_dos_fractions,wffile,wfread
!!
!! CHILDREN
!!
!! SOURCE
...
!DEBUG
!write(std_out,*)' getkpgnorm : enter '
!ENDDEBUG
...
!&  ' getkpgnorm: BUG -',ch10,&
!&  '  The argument npw_k should be a positive number,',ch10,&
!&  '  however, npw_k=',npw_k
