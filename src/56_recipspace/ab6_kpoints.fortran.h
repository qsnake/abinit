/* Fortran interface for m_ab6_kpoints.F90. */


#ifndef M_AB6_KPOINTS_EXPORT_H
#define M_AB6_KPOINTS_EXPORT_H

#define KPT_NAME(a,A)     ABI_FC_MOD(m_ab6_kpoints,M_AB6_KPOINTS,	\
...
void KPT_NAME(get_irreductible_zone,GET_IRREDUCTIBLE_ZONE) (int *sym, int *irrzon, double *phnons,
					 ...
					 int *nspden, unsigned int *ab6_errno);
