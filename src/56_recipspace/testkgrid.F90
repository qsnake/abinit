...
!DEBUG
!write(std_out,*)' testkgrid : enter '
!write(std_out,*)' testkgrid : vacuum(:)=',vacuum(:)
!ENDDEBUG
...
!  DEBUG
!  write(std_out,*)' testkgrid: bravais=',bravais(:)
...
!  DEBUG
!  write(std_out,*)' testkgrid : before metric'
!  write(std_out,*)' testkgrid : rprimd=',rprimd(:,:)
!  ENDDEBUG
