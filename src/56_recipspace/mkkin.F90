...
!!
!! PARENTS
!!      calc_vhxc_me,energy,ks_ddiago,m_commutator_vkbr,mkffnl,nstwf4,rhofermi3
!!      vtorho,vtorho3
!!
!! CHILDREN
!!
...
!scalars
 ...
 real(dp) :: ecutsm_inv,fsm,gpk1,gpk2,gpk3,htpisq,kinetic,kpg2,xx
!real(dp) :: d2fsm, dfsm
!arrays
...
!$OMP PARALLEL DO PRIVATE(gpk1,gpk2,gpk3,ig,kinetic,kpg2,xx,fsm) &
!$OMP SHARED(ecut,ecutsm,ecutsm_inv,gmet_break,htpisq,kinpw,kg,kpt,npw,effmass)
 do ig=1,npw
