...
!!
!! COPYRIGHT
!! Copyright (C) 1999-2012 ABINIT group (XG,LSI)
...
!!
!! PARENTS
!!      ep_setupqpt,getkgrid,irred_perts,loper3,m_bz_mesh,m_phdos,thm9
!!
!! CHILDREN
!!      sort_dp,wrtout
!!
...
!ENDDEBUG
 ...
 if (timrev/=1 .and. timrev/=0) then
   write(message,'(a,i0)')&
&   ' timrev should be 0 or 1, while it is equal to ',timrev
   MSG_BUG(message)
 end if
...
!  DEBUG
!  write(std_out,*)' gmet ',gmet(3,3)
!  write(std_out,*)' kpt '
!  do ikpt=1,nkpt
!  write(std_out,*)ikpt,kptns(:,ikpt)
!  end do
!  write(std_out,*)' symrc1 '
!  do isym=1,nsym1
!  write(std_out,*)isym,symrc1(:,:,isym)
!  end do
!  ENDDEBUG
...
&               '   Please, read carefully the description of the input variable chksymbreak,',ch10,&
