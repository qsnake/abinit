...
!!
!! PARENTS
!!      crho,m_ab6_kpoints,setsym,wfd_mkrho
!!
!! CHILDREN
...
!Local variables-------------------------------
! TRUE if antiferro symmetries are used in non-collinear magnetism
!scalars
...
!DEBUG
!write(std_out,*)' irrzg : enter '
!write(std_out,*)' nsym, n1,n2,n3 ',nsym, n1,n2,n3
!write(std_out,*)' nspden,nsppol ',nspden,nsppol
!write(std_out,*)' symrel ',symrel
!write(std_out,*)' tnons ',tnons
!count=count+1
...
!  DEBUG
!  write(std_out,*)' irrzg : before allocate, count=',count
!  write(std_out,*)' nsym_used,nsym,imagn,sppoldbl=',nsym_used,nsym,imagn,sppoldbl
!  write(std_out,*)' allocated symrel_used,tnons_used',allocated(symrel_used),allocated(tnons_used)
!  if(count==3)stop
!  ENDDEBUG
...
!  DEBUG
!  write(std_out,*)' irrzg : after allocate, count=',count
!  write(std_out,*)' nsym_used,nsym,imagn,sppoldbl=',nsym_used,nsym,imagn,sppoldbl
...
!  DEBUG
!  write(std_out,*)' irrzg : before zero work array'
!  if(count==3)stop
!  ENDDEBUG
...
!  DEBUG
!  write(std_out,*)' irrzg : before loop over reciprocal vectors, isym= ',isym
...
!DEBUG
!write(std_out,*)' irrzg : close to exit '
!if(count==3)stop
!ENDDEBUG
