...
#define ABI_FUNC 'fourier_interpol'
 ...
 use interfaces_66_paw, except_this_one => fourier_interpol
...
!================================
 if (nfft_out>=nfft_in) then ! From coarse to fine grid. If meshes are equivalent, call transgrid anyway because of optout, optin.
   nfftf    =nfft_out 
   ngfftf(:)=ngfft_out(:)
