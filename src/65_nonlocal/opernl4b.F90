...
#define ABI_FUNC 'opernl4b'
 ...
 use interfaces_65_nonlocal, except_this_one => opernl4b
...
!scalars
 ...
 integer :: iproj,ipw,ipw1,ipw2,jffkg,jj,jump,mblkpw,mmproj,nffkg
...
!$OMP SHARED(choice,dgxdt,ffnl,gmet,gxa,ia3,idir,indlmn,ispinor) &
!$OMP SHARED(itypat,jproj,jump,kg_k,kpg_k,kpt,lmnmax,mblkpw,mproj) &
!$OMP SHARED(ndgxdt,nffkg,nffkge,nincat,nkpg,nlang) &
!$OMP SHARED(nloalg,ph3d,npw,ntens,ntypat,vect)
