...
!!
!! PARENTS
!!      afterscfloop,mkvxcgga3,mkvxcstrgga3,poslifetime,rhohxc,rhohxcpositron
!!
!! CHILDREN
...
!no_abirules
!integer :: inv1,inv2,inv3,inv_ifft,ir
...
!      write(std_out,'(i5,4es15.7)' )ifft,wkcmpx(1,ifft),wkcmpx(2,ifft),&
...
!DEBUG
!write(std_out,*)' i1, i2, i3, ifft, rhonow(ifft,1,1),rhonow(ifft,1,2:4)'
!ifft=0
!do i3=1,n3
!do i2=1,n2
!do i1=1,n1
...
!ifft=ifft+1
!write(std_out,'(4i5,4f16.6)' )i1,i2,i3,ifft,rhonow(ifft,1,1:4)
!end do
!end do
!end do
!stop
