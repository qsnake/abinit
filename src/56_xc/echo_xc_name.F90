...
!!
!! COPYRIGHT
!! Copyright (C) 1999-2012 ABINIT group (MJV,CE)
...
&   // "  " // trim(message)
 ...
 else  ! libxc values should be printed out in libxc_functionals_init

#ifdef HAVE_DFT_LIBXC
   
#else
   write (message, '(a,a,a)') ' LibXC was not linked to this version: ', ch10, &
