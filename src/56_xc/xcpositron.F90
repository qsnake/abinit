...
!!
!! PARENTS
!!      pawxcpositron,pawxcsphpositron,rhohxc,rhohxcpositron
!!
!! CHILDREN
!!      invcb
!!
...
#define ABI_FUNC 'xcpositron'
 use interfaces_56_xc, except_this_one => xcpositron
...
! *************************************************************************
 ...
 if (gga.and.ixcpositron==2) stop 'xcpositron: GGA not yet implemented for ixcpositron=2 !'
 if (posdensity0_limit.and.ixcpositron==2)  &
& stop 'xcpositron: ixcpositron=2 cannot be treated in the zero positron density limit !'
 if (ixcpositron/=1.and.ixcpositron/=11.and.ixcpositron/=2.and.ixcpositron/=3.and.ixcpositron/=31) &
& stop 'xcpositron: unknown electron-positron correlation !'
...
!  GGA correction
   if (gga) then
     ...
     if (eps<zero) stop 'xcpositron: problem, negative GGA espilon !'
...
!  Debug statements: use polynomial functionals
 ...
 if (ixcpositron==2) ABI_DEALLOCATE(rsppts)
