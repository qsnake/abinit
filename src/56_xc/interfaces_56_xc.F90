...
interface
 subroutine pawxc3(corexc1,cplex_den,cplex_vxc,d2enxc,kxc,lm_size,lmselect,nhat1,nkxc,nspden,&  
  ...
  use defs_datatypes
  implicit none
  integer,intent(in) :: cplex_den
  integer,intent(in) :: cplex_vxc
  integer,intent(in) :: lm_size
  integer,intent(in) :: nkxc
  integer,intent(in) :: nspden
  integer,intent(in) :: option
...
interface
 subroutine pawxc3_gga(corexc1,cplex_den,cplex_vxc,d2enxc,kxc,lm_size,lmselect,nhat1,nkxc,nspden,&  
  &  option,pawang,pawrad,rhor1,usecore,usexcnhat,vxc1,xclevel,&  
  &  d2enxc_im) ! optional
  use defs_basis
  use defs_datatypes
