...
!!
!! COPYRIGHT
!! Copyright (C) 1998-2012 ABINIT group (DCA, XG, GMR, FD, SC)
...
!!
!! CHILDREN
!!      eleconf,psp10nl,psp2lo,spline,wrtout
!!
!! SOURCE
...
#define ABI_FUNC 'psp10in'
 ...
 use interfaces_65_psp, except_this_one => psp10in
...
#endif
!scalars
 integer :: ii,iln,iln0,index,ios,ipsang,isc,jj,kk,ll,mm,mproj,nn,nnonloc,nprl,nso
 real(dp) :: maxrad,rad_core,rad_cov,rad_long,rloc,yp1,ypn
