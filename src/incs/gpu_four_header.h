...
extern "C" {
  ...
  void gpu_update_ham_data_(double *enl,double *sij,double *gprimd,int *dimenl1,int *dimenl2,int *nspinor,int *ntypat,int *use_paw);
  
  void gpu_update_ffnl_ph3d_(double *ph3din,double *ffnlin,
