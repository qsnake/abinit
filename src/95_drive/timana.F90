...
!!
!! COPYRIGHT
!! Copyright (C) 1998-2012 ABINIT group (XG, GMR)
...
!Local variables-------------------------------
!scalars
 integer :: aslot,bslot,cslot,flag_count,flag_write,ierr,ii,ikpt,ipart,ilist,islot,isppol,itim,itimab,ltimab,maxii,me
 integer :: npart,nlist,nothers,nproc,npwmean,npwnbdmean,return_ncount
 integer :: spaceworld,temp_list,totcount,tslot,utimab
 real(dp) :: cpunm,lflops,other_cpu,other_wal,percent_limit,subcpu,subwal
 real(dp) :: timab_cpu,timab_wall,wallnm
 character(len=500) :: message
!arrays
 integer :: basic(mtim),ncount(mtim),ndata(mtim),tslots(mtim)
 integer,allocatable :: list(:)
 real(dp) :: ftimes(2,mtim),ftsec(2),mflops(mtim),nflops(mtim)
 real(dp) :: times(2,mtim),tsec(2),tsec_s(2)
 character(len=24) :: names(-1:mtim)
 character(len=*),parameter :: format01040 ="('- ',a24,f12.3,f6.1,f11.3,f6.1,i15)"
 character(len=*),parameter :: format01041 ="('- ',a24,f12.3,f6.1,f11.3,g12.3,i15)"
...
!Channels 900 to 999 are for optdriver=0 (again ...)
...
!WARNING : the slots from 1 to 99 should be avoided in the future ... They are hard to track.
 ...
 names(38)='ewald2 (+vdw_dftd2)     '; basic(38)=1
 ...
 names(101)='nstdy3                  '
 names(102)='nstwf3                  '
 names(108)='vtowfk3(contrib)        '; basic(108)=1
 names(118)='vtorho3 (1)             '; basic(118)=1
 names(120)='scfcv3                  '
 names(121)='vtorho3                 '
 names(122)='cgwf3                   '
 names(124)='vtorho3 (1)(2)          '
 names(125)='vtorho3 (2)             '
 names(126)='vtorho3-kpt loop        '; basic(126)=1
 names(127)='vtorho3 (4)             '
 names(128)='vtowfk3                 '
 names(129)='vtorho3:MPI             '; basic(129)=1
 names(130)='vtowfk3 (3)             '; basic(130)=1
 names(131)='vtowfk3 (1)             '; basic(131)=1
 names(132)='respfn                  '
 names(133)='respfn(kpgio)           '
 names(134)='respfn(pspini)          '
 names(135)='respfn(inwffil)         '
 names(136)='respfn(frozen)          '
 names(137)='respfn(dyxc13+bef.loper)'
 names(138)='respfn(after loper3)    '
 names(139)='vtowfk3 (loop)          '
 names(140)='cgwf3-O(npw)            '; basic(140)=1
 names(141)='loper3                  '
 names(142)='loper3(kpgio)           '
 names(143)='loper3(getmpw)          '
 names(144)='loper3(inwffil)         '
 names(146)='loper3(outwf)           '
 names(147)='loper3(eig2tot)         '
 names(148)='eig2tot                 '; basic(148)=1
 names(150)='nstdy3                  '
 names(152)='scfcv3-scprqt           '
 names(154)='scfcv3  (1)             '; basic(154)=1
 names(157)='rhotov3                 '
 names(158)='newvtr3                 '
 names(159)='dyfnl3                  '
 names(160)='scfcv3  (6)             '
 names(161)='nstdy3:synchro          '; basic(161)=1
 names(166)='vtorho3:synchro         '; basic(166)=1
 names(181)='mkvxc3                  '
 names(182)='dyxc13                  '; basic(182)=1
!names(184)='dyxc13(analysis)        '

 names(191)='invars2                 '; basic(191)=1
 names(192)='inkpts                  '

 names(197)='getgh1c%cgwf3           '
 names(198)='getgh1c%nstwf3          '
 names(199)='getgh1c%nstpaw3         '
 ...
 names(213)='projbd%nstpaw3          '
 names(214)='corrmetalwf1%vtowfk3    '
 ...
 names(441)='calc_sigc_me(xsum_mpi)  '
 ...
 names(501)='nonlinear               '
 names(502)='loop3dte                '
 names(511)='mv_3dte                 '; basic(511)=1
 names(512)='resp3dte                '; basic(512)=1
 ...
 names(561)='pawdij                  '; basic(561)=1
 names(562)='respfn:pawatm2ff        '; basic(562)=1
 names(563)='dyfro3:pawatm2ff        '; basic(563)=1
 names(564)='scfcv3:mknhat3          '; basic(564)=1
 names(565)='getgsc                  '
 names(566)='nstpaw3                 '; basic(566)=1
 names(567)='pawnstd2e               '
 ...
 names(652)='setup_bse               '
 names(653)='bse(rdkss)              '
 names(654)='bse(rdmkeps^-1)         '
 names(655)='bse(mkrho)              '
 names(656)='bse(mkexcham)           '
 names(657)='bse(mkexceps)           '
 names(658)='bse(wfd_wave_free)      '
 names(659)='bse(mk_Hur_commutator)  '
 names(660)='bse(exc_diago_driver)   '
 names(661)='bse(exc_haydock_driver) '


 names(670)='exc_build_ham           '
 names(671)='exc_build_ham(q=0)      '
 names(672)='exc_build_ham(block-res)'
 names(673)='exc_build_ham(block-coup'

 names(680)='exc_build_block         '
 names(681)='exc_build_ham(init,read)'
 names(682)='exc_build_ham(Coulomb)  '
 names(683)='exc_build_ham(exchange) '
 names(684)='exc_build_ham(synchro)  '
 names(685)='exc_build_ham(write_ham)'
 names(686)='exc_build_ham(exch.spin)'
...
!Slots up to 699 are reserved for bethe_salpeter code.
 ...
 names(844)='fourwf%cgwf3            '
 names(845)='fourwf%accrho3%vtowfk3  '
 names(846)='fourwf%mkrho2           '
 names(847)='fourwf%mkrho3           '
 names(848)='fourwf%susk !0          '
 names(849)='fourwf%susk !3          '
 names(850)='fourwf%susk_dyn0        '
 names(851)='fourwf%susk_dyn3        '
 names(854)='fourwf%tddft            '
 names(855)='fourwf%outkss           '
 names(856)='fourwf%prep_four        '
 names(857)='fourwf%susk _PAW        '
 names(858)='fourwf%accrho3%nstpaw3  '
 names(859)='fourwf%susk !3bis       '
...
!  write(std_out,*)itim,times(1:2,itim),ncount(itim),totcount
 end do
...
!    Gather the different parts of nonlop  (SHOULD BE REEXAMINED !)
     case(1) ; tslots(:4)=(/75, 221,223,229/)
     case(2) ; tslots(:4)=(/76, 222,225,227/)
     case(3) ; tslots(:2)=(/77, 224/)
     case(4) ; tslots(:2)=(/78, 226/)
     case(5) ; tslots(:2)=(/79, 228/)
!      Gather the different parts of selected time channels
     case(6) ; tslots(:10)=(/97, 75,76,77,78,79,220,230,231,232/)
!      Gather the different parts of fourwf (NOTE : should attribute the channel 840 to one of the 4 modes !!!)
     case(7) ; tslots(:3)=(/802, 841,844/)
     case(8) ; tslots(:4)=(/803, 842,843,846/)
     case(9) ; tslots(:10)=(/804, 845,847,848,850,854,858,859,861,862/)
     case(10) ; tslots(:6)=(/805, 849,851,857,871,872/)
!      In the following, the part coming from the prep_fourwf interface
!      is added to the total.
     case(11) ; tslots(:7)=(/801, 802,803,804,805,840,856/)
!      Gather the different parts of prep_fourwf
     case(13) ; tslots(:3)=(/539, 537,538/)
!      Gather the different parts of fourdp
     case(14) ; tslots(:11)=(/9, 260,261,262,263,264,265,266,267,268,269/)
!      Gather the different parts of getghc
     case(15) ; tslots(:9)=(/200, 201,202,203,204,205,206,207,208/)
!      Gather the different parts of projbd
     case(16) ; tslots(:3)=(/210, 211,212/)
...
!Compute xc part of rhohxc and mkvxc3, minus the calls to fourdp inside that part
...
&     '  CPU =',times(1,itim),', Wall=',times(2,itim),' ncount=',ncount(itim), &
&     ' flops=',nflops(itim)
...
!DEBUG
!write(std_out,*)' timana : after get time reports  '
!if(.true.)stop
!ENDDEBUG
...
&     '-'
     write(ab_out, '(a,t34,a,t42,a,t50,a,t59,a,t65,a)' )&
...
&     '-'
     ...
     write(ab_out, '(a,t34,a,t43,a,t51,a,t59,a,t71,a)' )&
...
!  DEBUG
!  write(std_out,*)' timana : will Write timing output for cpu times '
!  call flush(std_out) 
!  ENDDEBUG
...
&     '- as well as % of the total time and number of calls '
     write(ab_out,'(a,t35,a,t43,a,t51,a,t60,a,t66,a)')&
&     '- routine        ','cpu','%','wall','%', ' number of calls '
     write(ab_out,'(a,t35,a,t43,a,t51,a,t60,a,t66,a,t78,a)')&
&     '-                ','   ',' ','    ',' ','  (-1=no count)'
   else if (  papiopt == 1 ) then
     write(ab_out,'(/,a,/,a,/,a/)' )&
...
&     '- by decreasing CPU '
     ...
     write(ab_out, '(a,t34,a,t43,a,t51,a,t58,a,t71,a)' )&
&     '- routine','wall','%', 'cpu', 'Gigaflops', ' number of calls '
...
!      DEBUG
!      write(ab_out,*)' timana : will examine partitioning ipart=',ipart
!      ENDDEBUG

       list(:)=0 
       select case(ipart)

         case(1); list(:11)=(/1,41,42,43,44,45,640,46,49,50,mtim/)      ; message='abinit '
         case(2); list(:13)=(/640,641,642,700,132,84,301,401,501,650,643,644,mtim/)  ; message='driver '
         case(3); list(:13)=(/700,703,704,705,33,701,34,35,36,706,702,707,708/)       ; message='gstateimg+gstate '
         case(4); list(:19)=(/238,54,240,241,56,242,60,52,68,239,243,244,245,246,247,248,61,249,mtim/); message='scfcv '
         case(5); list(:7)=(/940,941,942,943,944,945,mtim/)             ; message= 'rhotov '
         case(6); list(:21)=(/980,981,982,983,984,28,985,271,986,987,988,989,990,991,992,993,994,995,996,997,mtim/)
           message= 'vtorho '
         case(7); list(:14)=(/28,31,22,530,585,583,590,222,572,842,537,586,591,mtim/) ; message='vtowfk '
         case(8)
...
!            message='lobpcgwf (light analysis: for a deeper one, use abs(timopt)=3 or 4)'
         ...
         case(9); list(:4)=(/22,201,40,211/)                            ; message='cgwf '
         case(10);list(:8)=(/132,133,134,135,136,137,138,141/)          ; message='respfn '
         case(11);list(:8)=(/141,142,143,144,120,146,147,mtim/)         ; message='loper3 '
         case(12);list(:10)=(/120,154,121,157,152,158,160,150,564,566/) ; message='scfcv3 '
         case(13);list(:9)=(/121,118,128,126,287,166,129,127,556/)      ; message='vtorho3 '
         case(14);list(:9)=(/128,131,122,845,288,214,108,130,565/)      ; message='vtowfk3 '
         case(15);list(:8)=(/122,140,202,197,212,227,228,844/)          ; message='cgwf3 '
         case(16);list(:4)=(/200,841,221,98/)                           ; message='getghc '
         case(17);list(:20)=(/801,840,841,842,843,844,845,846,847,848,849,850,851,852,853,854,855,856,857,858/)
           message='fourwf (upwards partitioning)'
         case(18);list(:5)=(/933,934,936,937,938/)                      ; message='outkss '
         case(19);list(:14)=(/301,302,315,316,319,304,305,320,321,306,307,308,309,310/) 
           message='screening '
         case(20);list(:13)=(/401,402,403,404,405,406,407,408,409,421,423,424,425/); message='sigma  '
!          case(21);list(:12)=(/431,432,433,434,435,436,437,438,439,440,441,442/)    ; message='calc_sigc_me '
         case(21);list(:9)=(/431,432,433,434,435,445,440,441,442/)     ; message='calc_sigc_me '
         case(23);list(:11)=(/630,631,632,633,634,545,635,636,637,638,mtim/)         ; message='prep_getghc '
         case(24);list(:4)=(/539,856,547,548/)                          ; message='prep_fourwf '
         case(25);list(:5)=(/570,231,232,581,mtim/)                     ; message='prep_nonlop '
         case(26);list(:6)=(/790,791,792,793,794,795/)                  ; message='mkrho (upwards partitioning)'
...
!          message='vtorhorec '
         case(28);list(:10)=(/650,651,653,654,655,656,658,659,660,661/) 
           message='bethe_salpeter '
         case(29);list(:8)=(/740,741,742,743,744,745,746,747/)          ; message='suscep_stat '
         case(30);list(:9)=(/750,751,848,849,753,756,859,757,755/)      ; message='susk '
         case(31);list(:8)=(/760,761,764,861,871,765,862,872/)          ; message='suskmm '
         case(32);list(:8)=(/710,711,712,713,714,715,716,717/)          ; message='inwffil '
         case(33);list(:10)=(/720,721,722,723,724,725,726,727,67,mtim/)  ; message='wfsinp '
         case(34);list(:5)=(/770,771,772,272,290/)                      ; message='initwf '
         case(35);list(:9)=(/780,781,782,783,784,785,786,291,292/)      ; message='newkpt '
         case(36);list(:8)=(/93,901,902,903,904,905,268,mtim/)          ; message='newvtr '
         case(37);list(:2)=(/94,269/)                                   ; message='newrho '
         case(38);list(:11)=(/9,260,261,262,263,264,265,266,267,268,269/) ; message=' fourdp (upwards partitioning)'
         case(39);list(:8)=(/250,251,252,253,254,255,256,257/)          ; message='afterscfloop '
         case(40);list(:5)=(/910,911,912,913,914/)                      ; message='forstr '
         case(41);list(:10)=(/920,921,927,922,923,926,924,65,925,mtim/) ; message='forstrnps '
         case(42);list(:4)=(/670,671,672,673/)                          ; message='exc_build_ham '
         case(43);list(:7)=(/680,681,682,683,684,685,686/)              ; message='exc_build_block'
         case(44);list(:6)=(/690,691,692,693,694,695/)                  ; message='exc_haydock_driver '
         case(45);list(:20)=(/950,951,952,953,954,955,956,957,958,959,960,961,962,963,964,965,966,967,968,969/)
           message='outscfcv '
       ...
       if(ncount(list(1))/=0)then
         write(ab_out,'(/,a,a)')' Partitioning of ',trim(message)
         subcpu=0.0_dp
         subwal=0.0_dp
         do ilist=1,nlist
!          When the LAST item is mtim, a complement is evaluated (count number set to -1)
           if(ilist==nlist .and. list(nlist)==mtim)then
             ...
             if(times(2,mtim)>1.2d0 .and. wallnm*times(2,mtim)>3.d0)then
               write(ab_out, '(3a,es16.6,4a,es16.6,2a)')&
...
&               '   is negative '
           ...
           if(ncount(list(ilist))/=0)then
             if (papiopt == 0) then
               if(times(2,list(ilist))*wallnm>0.02d0 .or. ilist==1)then   ! Does not write a slot if the wall time ratio is below a threshold
                 write(ab_out,format01040)names(list(ilist)),&
&                 times(1,list(ilist)),times(1,list(ilist))*cpunm,&
&                 times(2,list(ilist)),times(2,list(ilist))*wallnm,&
&                 ncount(list(ilist))
...
&           '- subtotal             ', subcpu,subcpu*cpunm,subwal,subwal*wallnm
           ...
           if( wallnm*abs(subwal-times(2,list(1)))>1.d0 .and. abs(subwal-times(2,list(1)))>0.2d0 )then
             write(ab_out, '(3a,es16.6,2a,es16.6,4a,es16.6,2a,es16.6,6a,i4)')&
&             ' Note : the partitioning does not work well for this routine.',ch10,&
...
&             '   nlist=',nlist
             do ilist=1,nlist
               write(ab_out, '(a,i4,i4,es16.6,i8)' )&
...
&         ncount(list(ilist))
     ...
     nlist=17
     list(:17)=(/550,551,552,553,554,555,556,558,559,560,561,562,563,564,565,566,567/)
     flag_write=1
     do ilist=1,nlist
       if(ncount(list(ilist))/=0)then
         if(flag_write==1)then
           write(ab_out, '(/,a)' ) ' Additional information about PAW segments'
           flag_write=0
         end if
         write(ab_out,format01040)names(list(ilist)),&
&         times(1,list(ilist)),times(1,list(ilist))*cpunm,&
...
&       '                                 (sec)                (msec)              (microsec)'
       ...
       do ilist=1,nlist
         if(ncount(list(ilist))/=0)then
           write(ab_out, '(a,a24,f12.3,i10,f12.3,i10,f12.3)' )'- ',names(list(ilist)),&
...
&           *dble(ndata(list(ilist))))
           ...
           write(ab_out, '(a,a24,f12.3,i10)' )'- ',names(list(ilist)),&
&           times(1,list(ilist)),ncount(list(ilist))
         end if
       end do !ilist
     else
