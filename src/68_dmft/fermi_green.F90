...
!=====================
 ...
 if (f_precision<10_dp)  then
   call newton(cryst_struc,green,mpi_enreg,paw_dmft,pawang,self,&
...
!==========================================================
 ...
 call integrate_green(cryst_struc,green,mpi_enreg,paw_dmft,pawang,prtopt=0,opt_ksloc=3)
