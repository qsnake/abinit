...
!!      dyson,hubbard_one,init_green,initialize_self,ldau_self,leave_new
!!      print_green,rw_self,wrtout
!!
!! SOURCE
...
!character(len=500) :: message
 ...
 call init_green(greenr,paw_dmft,wtype="real")
...
&   pawang,pawtab,prtopt,self_old%hdc,weissr)
...
!=======================================================================
 ...
 call compute_green(cryst_struc,greenr,mpi_enreg,paw_dmft,pawang,1,selfr,opt_self=1)
 call print_green("realw",greenr,4,paw_dmft,pawprtvol=3)
 call rw_self(selfr,mpi_enreg,paw_dmft,prtopt=2,opt_rw=2)
