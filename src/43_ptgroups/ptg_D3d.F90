...
! List of irreducible representations.
 ...
 Irr(5)%mat(:,:,5) =  RESHAPE( (/0.0+0.0*j, -0.5+0.86603*j, -0.5-0.86603*j, 0.0+0.0*j/), (/2, 2/) )
 Irr(5)%mat(:,:,6) =  RESHAPE( (/0.0+0.0*j, -0.5-0.86603*j, -0.5+0.86603*j, 0.0+0.0*j/), (/2, 2/) )
 ...
 Irr(6)%mat(:,:,5) =  RESHAPE( (/0.0+0.0*j, -0.5+0.86603*j, -0.5-0.86603*j, 0.0+0.0*j/), (/2, 2/) )
 Irr(6)%mat(:,:,6) =  RESHAPE( (/0.0+0.0*j, -0.5-0.86603*j, -0.5+0.86603*j, 0.0+0.0*j/), (/2, 2/) )
