...
! List of irreducible representations.
 ...
 Irr(5)%dim = 2
 Irr(5)%nsym = 8
 ABI_ALLOCATE(Irr(5)%mat,(2,2,8))
 Irr(5)%mat(:,:,1) =  RESHAPE( (/1.0, 0.0, 0.0, 1.0/), (/2, 2/) )
 Irr(5)%mat(:,:,2) =  RESHAPE( (/-1.0, 0.0, 0.0, -1.0/), (/2, 2/) )
 Irr(5)%mat(:,:,3) =  RESHAPE( (/0.0+1.0*j, 0.0+0.0*j, 0.0+0.0*j, -0.0-1.0*j/), (/2, 2/) )
 Irr(5)%mat(:,:,4) =  RESHAPE( (/-0.0-1.0*j, 0.0+0.0*j, 0.0+0.0*j, 0.0+1.0*j/), (/2, 2/) )
 Irr(5)%mat(:,:,5) =  RESHAPE( (/0.0, 1.0, 1.0, 0.0/), (/2, 2/) )
 Irr(5)%mat(:,:,6) =  RESHAPE( (/0.0, -1.0, -1.0, 0.0/), (/2, 2/) )
 Irr(5)%mat(:,:,7) =  RESHAPE( (/0.0+0.0*j, 0.0+1.0*j, -0.0-1.0*j, 0.0+0.0*j/), (/2, 2/) )
 Irr(5)%mat(:,:,8) =  RESHAPE( (/0.0+0.0*j, -0.0-1.0*j, 0.0+1.0*j, 0.0+0.0*j/), (/2, 2/) )
