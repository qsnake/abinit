...
! List of irreducible representations.
 ...
 Irr(5)%dim = 2
 Irr(5)%nsym = 12
 ABI_ALLOCATE(Irr(5)%mat,(2,2,12))
 Irr(5)%mat(:,:,1) =  RESHAPE( (/1.0, 0.0, 0.0, 1.0/), (/2, 2/) )
 Irr(5)%mat(:,:,2) =  RESHAPE( (/-0.5+0.86603*j, 0.0+0.0*j, 0.0+0.0*j, -0.5-0.86603*j/), (/2, 2/) )
 Irr(5)%mat(:,:,3) =  RESHAPE( (/-0.5-0.86603*j, 0.0+0.0*j, 0.0+0.0*j, -0.5+0.86603*j/), (/2, 2/) )
 ...
 Irr(5)%mat(:,:,8) =  RESHAPE( (/0.0+0.0*j, -0.5+0.86603*j, -0.5-0.86603*j, 0.0+0.0*j/), (/2, 2/) )
 Irr(5)%mat(:,:,9) =  RESHAPE( (/0.0+0.0*j, -0.5-0.86603*j, -0.5+0.86603*j, 0.0+0.0*j/), (/2, 2/) )
 Irr(5)%mat(:,:,10) =  RESHAPE( (/0.0, 1.0, 1.0, 0.0/), (/2, 2/) )
 Irr(5)%mat(:,:,11) =  RESHAPE( (/0.0+0.0*j, -0.5+0.86603*j, -0.5-0.86603*j, 0.0+0.0*j/), (/2, 2/) )
 Irr(5)%mat(:,:,12) =  RESHAPE( (/0.0+0.0*j, -0.5-0.86603*j, -0.5+0.86603*j, 0.0+0.0*j/), (/2, 2/) )

 Irr(6)%name = "E1"
 Irr(6)%dim = 2
 Irr(6)%nsym = 12
 ABI_ALLOCATE(Irr(6)%mat,(2,2,12))
 Irr(6)%mat(:,:,1) =  RESHAPE( (/1.0, 0.0, 0.0, 1.0/), (/2, 2/) )
 Irr(6)%mat(:,:,2) =  RESHAPE( (/-0.5+0.86603*j, 0.0+0.0*j, 0.0+0.0*j, -0.5-0.86603*j/), (/2, 2/) )
 Irr(6)%mat(:,:,3) =  RESHAPE( (/-0.5-0.86603*j, 0.0+0.0*j, 0.0+0.0*j, -0.5+0.86603*j/), (/2, 2/) )
 ...
 Irr(6)%mat(:,:,8) =  RESHAPE( (/0.0+0.0*j, -0.5+0.86603*j, -0.5-0.86603*j, 0.0+0.0*j/), (/2, 2/) )
 Irr(6)%mat(:,:,9) =  RESHAPE( (/0.0+0.0*j, -0.5-0.86603*j, -0.5+0.86603*j, 0.0+0.0*j/), (/2, 2/) )
 Irr(6)%mat(:,:,10) =  RESHAPE( (/0.0, -1.0, -1.0, 0.0/), (/2, 2/) )
 Irr(6)%mat(:,:,11) =  RESHAPE( (/0.0+0.0*j, 0.5-0.86603*j, 0.5+0.86603*j, 0.0+0.0*j/), (/2, 2/) )
 Irr(6)%mat(:,:,12) =  RESHAPE( (/0.0+0.0*j, 0.5+0.86603*j, 0.5-0.86603*j, 0.0+0.0*j/), (/2, 2/) )
