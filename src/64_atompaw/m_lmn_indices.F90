...
! Public procedures.
 ...
 public :: make_indklmn    ! Calculates the indklmn(6,lmn2_size) table giving
                           !   klm, kln, abs(il-jl), (il+jl), ilm and jlm for each symmetric klmn=(ilmn,jlmn)
...
!!  Compute the indklmn indexes giving klm, kln, abs(il-jl) and (il+jl)
...
!!
!! OUTPUT
!!  indklmn(6,lmn2_size)=Array giving klm, kln, abs(il-jl), (il+jl), ilm and jlm
...
!scalars
 ...
 integer,intent(out) :: indklmn(6,lmn2_size)
...
!arrays
 integer,intent(in) :: indlmn(6,lmn_size)
 integer,intent(in) :: indklmn(6,lmn2_size)
...
!!
!! PARENTS
!!      m_lmn_indices,m_paw_slater,pawmknhat_psipsi
!!
!! CHILDREN
!!
!! SOURCE
