...
!!
!! COPYRIGHT
!! Copyright (C) 1998-2012 ABINIT group (MT,FJ,MG)
...
! *************************************************************************
 ...
 ABI_ALLOCATE(Rmesh%rad    ,(Rmesh%mesh_size))
 ABI_ALLOCATE(Rmesh%radfact,(Rmesh%mesh_size))
 ABI_ALLOCATE(Rmesh%simfact,(Rmesh%mesh_size))
...
!Do not modify the following lines by hand.
#undef ABI_FUNC
#define ABI_FUNC 'nullify_radmesh'
!End of the abilint section
...
!Do not modify the following lines by hand.
#undef ABI_FUNC
#define ABI_FUNC 'destroy_radmesh'
!End of the abilint section
...
!!
!! PARENTS
!!      m_atom,m_paw_pwij,m_radmesh,optics_paw_core,psp7in
!!
!! CHILDREN
!!      deducer0,simp_gen
!!
...
!!      pawfrnhat,pawinit,pawkij,pawnabla_init,pawpuxinit,pawshpfun,pawtwdij
!!      pawtwdij_1,pawtwdij_2a,pawtwdij_2b,pawtwdij_2c,pawtwdij_2d,pawtwdij_2e
!!      pawtwdij_2f,pawxc,pawxc3,pawxc3_gga,pawxcm,pawxcmpositron,pawxcpositron
!!      poslifetime,psp7cg,psp7in,psp7lo,psp7nl,qijb_bk,qijb_kk,smatrix_pawinit
!!
!! CHILDREN
!!      deducer0,simp_gen
!!
...
!!
!! PARENTS
!!      Lij,denfgr,m_paw_slater,m_paw_toolbox,m_radmesh,make_efg_onsite
!!      optics_paw,optics_paw_core,pawdenpot,pawdensities,pawdijso,pawfrnhat
!!      pawnabla_init,pawtwdij_2a,pawtwdij_2c,pawtwdij_2d,pawvhnzc,pawxc
!!      pawxcsph,pawxcsphpositron,psp7in
!!
!! CHILDREN
!!      deducer0,simp_gen
!!
...
!!      pawtwdij_1,pawxc,pawxc3_gga,pawxcsph,pawxcsphpositron,poslifetime
!!      psp7cc,spline_paw_fncs
!!
!! CHILDREN
!!      deducer0,simp_gen
!!
...
!!
!! PARENTS
!!      m_radmesh,pawdenpot,pawinit,pawpuxinit,pawtwdij_2a,pawtwdij_2c
!!      pawtwdij_2d,pawtwdij_2f,pawvhnzc,psp7in
!!
!! CHILDREN
!!      deducer0,simp_gen
!!
