...
!!
!! COPYRIGHT
!! Copyright (C) 1999-2012 ABINIT group (GMR)
...
!!
!! PARENTS
!!      invars2m,irred_perts,m_bands_sym,m_bz_mesh,m_gamma,m_gsphere,m_io_gkk
!!      rdddb9,read_gkk,respfn,symdyma
!!
!! CHILDREN
!!      wrap2_pmhalf,wrtout
!!
...
!    DEBUG
!    write(std_out,*)isym,itirev
!    write(std_out,*)((symrec(ii,jj,isym),ii=1,3),jj=1,3)
!    write(std_out,*)qsym(1),qsym(2),qsym(3)
!    write(std_out,*)(symq(ii,itirev,isym),ii=1,4)
!    write(std_out,*)
!    ENDDEBUG
