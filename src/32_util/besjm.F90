...
!!
!! COPYRIGHT
!! Copyright (C) 1998-2012 ABINIT group (DCG, XG)
...
!! besjm compute multiple values, and relies on precomputed values of sin and
!! cos of y.
...
!!
!! PARENTS
!!      init_bess_spl,init_ylm_spl,mlwfovlp_radial,psp1nl
!!
!! CHILDREN
!!      leave_new,wrtout
!!
...
&   ' besjm : BUG -',ch10,&
&   '  besjm only defined for nn in [0,5]; input was nn=',nn,'.'
