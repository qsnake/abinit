...
!!
!! PARENTS
!!      calc_ffm,eli_lambda_1d,evdw_wannier,exc_spectra,kramerskronig,m_gamma
!!      m_phdos,mka2f,mka2fQgrid,mka2f_tr,mlwfovlp_projpaw,mlwfovlp_radial
!!      recip_ylm,scphon_free_energy,scphon_make_phonon_dos
!!
!! CHILDREN
!!
!! SOURCE
