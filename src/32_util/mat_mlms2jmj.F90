...
!    write(std_out,*) "ind_msml",ms1,ml1,ind_msml(ms1,ml1)
   end do
 end do
...
!        write(std_out,*) "3",jc1,ind_msml(1,nint(xmj+0.5))
!        write(std_out,*) "4",jc1,ind_msml(2,nint(xmj-0.5))
       end if
     end if
     if(nint(xj+0.5)==ll) then
       mlms2jmj(ind_msml(1,nint(xmj+0.5)),jc1)=invsqrt2lp1*(sqrt(float(ll)+xmj+0.5))
       mlms2jmj(ind_msml(2,nint(xmj-0.5)),jc1)=-invsqrt2lp1*(sqrt(float(ll)-xmj+0.5))
!      write(std_out,*) "5",jc1,ind_msml(1,nint(xmj+0.5))
!      write(std_out,*) "6",jc1,ind_msml(2,nint(xmj-0.5))
     end if
   end do
 end do
