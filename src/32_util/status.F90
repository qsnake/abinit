...
!!
!! COPYRIGHT
!! Copyright (C) 1998-2012 ABINIT group (XG,TD)
...
!!
!! PARENTS
!!      abinit,accrho3,cgwf,cgwf3,driver,getgh1c,getghc,gstate,gstateimg
!!      loop3dte,loper3,m_ab6_invars_f90,mv_3dte,nonlinear,resp3dte,respfn
!!      rhofermi3,scfcv,scfcv3,suscep,vtorho,vtorho3,vtorhotf,vtowfk,vtowfk3
!!      wfkfermi3
!!
!! CHILDREN
...
!DEBUG
!write(std_out,*)' status : statnu=',statnu
!ENDDEBUG
