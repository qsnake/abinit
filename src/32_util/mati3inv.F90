...
!!      invars2m,irred_perts,m_ab6_symmetry,m_crystal,m_fft_mesh,m_io_gkk
!!      m_ptgroups,nstdy3,optic,outscfcv,rdddb9,read_gkk,setsym,strainsym
!!      symdij,symdyma,thmeig,wfconv
!!
!! CHILDREN
!!      leave_new,wrtout
!!
