...
!!
!! COPYRIGHT
!! Copyright (C) 2004-2012 ABINIT group (XW).
...
!DEBUG
!write(std_out,*)'initberry3:nkpt',nkpt
!ENDDEBUG
...
&   '  initberry3: for direction ',idir,', nkstr = ',dtefield%nkstr(idir),&
...
!      Set up the basis sphere of plane waves at kpt1
       kg_tmp(:,:) = 0
       call kpgio(ecut_eff,dtset%exchn2n3d,gmet,dtset%istwfk,kg_tmp,dtfil%fnametmp_kg1,&
&       kpt1,dtset%mkmem,dtset%nband,nkpt,'PERS',mpi_enreg,mpw,&
&       npwarr_tmp,npwtot,dtset%nsppol,dtfil%unkg1)
