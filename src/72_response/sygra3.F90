...
!!
!! COPYRIGHT
!! Copyright (C) 1999-2012 ABINIT group (DCA,XG)
...
!DEBUG
!write(std_out,*)' sygra3 : enter '
!write(std_out,*)' sygra3 : qpt(:)',qpt(:)
!do ia=1,natom
!do mu=1,3
!write(std_out,*)' sygra3 : deunsy(:2,mu,ia)',deunsy(:2,mu,ia)
!enddo
!enddo
!ENDDEBUG
...
!  DEBUG
!  write(std_out,*)' sygra3 : desym(:2,:3,:natom),qpt(:)',desym(:2,:3,:natom),qpt(:)
!  ENDDEBUG
   do ia=1,natom
!    DEBUG
!    write(std_out,*)' sygra3 : ia=',ia
!    ENDDEBUG
     do mu=1,3
       sumr=zero
       sumi=zero
!      DEBUG
!      write(std_out,*)' sygra3 : mu=',mu
!      ENDDEBUG
       do isym=1,nsym
...
!        sumi=sumi+im
!        DEBUG
!        write(std_out,*)' sygra3 : isym,indsym(4,isym,ia),arg,re,im,sumr,sumi',&
...
!      DEBUG
!      write(std_out,*)' sygra3 : desym(:,mu,ia)',desym(:,mu,ia)
!      ENDDEBUG
     end do
   end do
 end if
