...
!!
!! COPYRIGHT
!! Copyright (C) 2000-2012 ABINIT group (GMR,XG)
...
!  Apply each transformation to redvec and store at the correct location
!  in redvtr (iatom -> jatom)
   do isym=1,nsym
     do iatom=1,natom
...
!DEBUG
!write(std_out,*)' symph3 : degeneracy=',degeneracy(:)
!ENDDEBUG
