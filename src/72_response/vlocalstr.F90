...
!scalars
 ...
 real(dp) :: aa,bb,cc,cutoff,dd,dgsqds,dgsquards,diff
 real(dp) :: dq,dq2div6,dqdiv6,dqm1,ee,ff,gmag,gsq,gsquar,ph1
 real(dp) :: ph2,ph3,phi,phimag,phr,phre
 real(dp) :: sfi,sfr,term,vion1,vion2,x1,x2,x3
