...
!!
!! PARENTS
!!      ingeo,ingeobld,inkpts,inqpt,invacuum,invars0,invars1,invars2,invars7w
!!      invars9,localorb_S,lwf,m_ab6_invars_f90,newsp,parsefile,ujdet
!!
!! CHILDREN
!!      appdig,inarray,inupper,leave_new,wrtout
!!
!! SOURCE
...
!DEBUG
!write(std_out,*)' intagm : enter, token,jdtset= ',token,jdtset
...
&   '  jdtset=',jdtset,', while it should be non-negative.'
 ...
 if(jdtset>9999)then
   write(message, '(a,a,a,a,i6,a)' ) ch10,&
&   ' intagm : BUG -',ch10,&
&   '  jdtset=',jdtset,', while it must be lower than 10000.'
   call wrtout(std_out,message,'COLL')
   call leave_new('COLL')
 end if
...
!    DEBUG
!    write(std_out,*)' intagm : token=',token
!    write(std_out,*)' intagm : itoken=',itoken
!    write(std_out,*)' intagm : appen=',appen
!    write(std_out,*)' intagm : cs=',cs
!    ENDDEBUG
...
!      If the multi-dataset mode is used, exactly zero or two token must be found
       ...
       if(sum_token/=0 .and. sum_token/=2) then
         write(message, '(a,a,a,a,a,a,a,a,i3,a,a,a,a,a,a,a)' )ch10,&
&         ' intagm : ERROR - ',ch10,&
...
&           '  Action : remove this occurence.'
           ...
           write(message, '(a,a,a,a,a,a,a,a,i1,a,a,a,a,a)' )ch10,&
&           ' intagm : ERROR - ',ch10,&
