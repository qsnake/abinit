...
!!
!! PARENTS
!!      anaddb,importcml,localorb_S,lwf,newsp,parsefile
!!
!! CHILDREN
...
!DEBUG
!write(std_out,*)' instrng : enter '
!write(std_out,*)' filnam =',trim(filnam)
!stop
!ENDDEBUG
...
!  DEBUG
!  write(std_out,*)' instrng, ios=',ios,' echo :',trim(line(1:fnlen+20))
!  ENDDEBUG
...
!    Check for the occurence of a minus sign followed by a blank
     ...
     if (ij>0 .and. option==1) then
       write(message, '(a,a,a,a,i4,a,a,a,a,a,a,a,a,a,a,a)' ) ch10,&
&       ' instrng : ERROR - ',ch10,&
&       '  It is observed in the input file, line number',&
...
!  If mline is reached, something is wrong
   if (iline>=mline) then
     write(message, '(a,a,a,a,i10,a,a,a,i10,a,a,a,a)' ) ch10,&
&     ' instrng : ERROR -',ch10,&
...
!DEBUG
!write(std_out,*)' instrng : string =',trim(string)
!ENDDEBUG
