...
int main(int argc, const char **argv)
{
  ...
  if (ab6_symmetry_set_lattice(sym, rprimd) != AB6_NO_ERROR)
    {
  ...
  if (ab6_symmetry_set_structure(sym, 2, typeAt, xRed) != AB6_NO_ERROR)
    {
      ab6_symmetry_free(sym);
  ...
  if (ab6_symmetry_set_spin(sym, spinAt) != AB6_NO_ERROR)
    {
      ab6_symmetry_free(sym);
  ...
  err = ab6_symmetry_get_matrices(sym, &nSym, &syms, &trans, &symAfm);
  if (err != AB6_NO_ERROR && err != AB6_ERROR_SYM_BRAVAIS_XRED)
    {
      ab6_symmetry_free(sym);
  ...
  if (ab6_symmetry_get_multiplicity(sym, &multiplicity) != AB6_NO_ERROR)
    {
      ab6_symmetry_free(sym);
      return 1;
    }
  ...
  if (ab6_symmetry_get_group(sym, &sp, &spgrp, &grpMagn, magn) != AB6_NO_ERROR)
    {
      ab6_symmetry_free(sym);
      return 1;
    }
  ...
  if (ab6_kpoints_get_mp_k_grid(sym, &nkpt, &kpt, &wkpt, ngkpt, 1, shiftk) != AB6_NO_ERROR)
    {
      ab6_symmetry_free(sym);
      return 1;
    }
  ...
  if (ab6_kpoints_get_auto_k_grid(sym, &nkpt, &kpt, &wkpt, 2.) != AB6_NO_ERROR)
    {
      ab6_symmetry_free(sym);
      return 1;
    }
